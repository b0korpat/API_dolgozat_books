...
const initializeDB = async () => {
    ...
    const books = [
        ...
        { title: "The Hobbit", author: "asd", description: "Hobbitok vannak benne", year: 1937 },
        { title: "The Lord of the Rings", author: "asd", description: "gyuruk vannak benne", year: 1954 },
            ];
